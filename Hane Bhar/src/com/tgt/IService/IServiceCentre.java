...
public interface IServiceCentre<T> {
    ...
    public int verifieCentre(String s);
      public void updateSelonVu(T t) throws SQLException ;
      public List<T> trierParVu() throws SQLException;
   //    public ObservableList<T> readAllCentreVu() throws SQLException ;
    
 //    public ObservableList<T> readAllCentreImageNote();
