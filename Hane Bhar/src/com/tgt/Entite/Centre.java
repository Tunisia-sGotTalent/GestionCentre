...
public class Centre implements Comparable<Centre>{
    ...
    private int vu_centre;
    private ImageView photo_centre;
    private ImageView note_centre;
    public Centre()
    { this.id_centre=0;
        this.nom_centre="";
        this.adresse_centre="";
    ...
    public Centre(int id, String nom, String adresse, String das,String contacte, int numero) {
       ...
       public Centre(int id, String nom, String adresse, String das,String contacte, int numero,int vu_centre) {
        this.id_centre = id;
        this.nom_centre = nom;
        this.adresse_centre = adresse;
        this.das_centre=das;
    ...
    public ImageView getNote_centre() {
        return note_centre;
    }

    public void setNote_centre(ImageView note_centre) {
        this.note_centre = note_centre;
    }

    public int getVu_centre() {
        return vu_centre;
    }

    public void setVu_centre(int vu_centre) {
        this.vu_centre = vu_centre;
    }
    public Centre(int id_centre,ImageView photo_centre, String nom, String adresse, String das,String contacte, int numero) {
     ...
     public Centre(int id_centre,ImageView photo_centre, String nom, String adresse, String das,String contacte, int numero, ImageView note_centre) {
        this.id_centre = id_centre;
        this.nom_centre = nom;
        this.adresse_centre = adresse;
        this.das_centre=das;
    ...
    public Centre(String nom, String adresse, String das,String contacte, int numero) {
     ...
     public Centre(int id,String nom, String adresse, String das,String contacte,String image, int numero,int vu) {
this.id_centre=id;
        this.nom_centre = nom;
        this.adresse_centre = adresse;
        this.das_centre=das;
    ...
    public ImageView getPhoto_centre() {
        return photo_centre;
    }

    public void setPhoto_centre(ImageView photo_centre) {
        this.photo_centre = photo_centre;
    }
